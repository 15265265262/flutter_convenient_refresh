...
class RefreshScrollPhysics extends ScrollPhysics {
  final ScrollJudgment scrollJudgment;
  RefreshScrollPhysics({ScrollPhysics parent ,this.scrollJudgment}) : super(parent: parent);

  @override
  RefreshScrollPhysics applyTo(ScrollPhysics ancestor) {
    return RefreshScrollPhysics(parent: buildParent(ancestor),scrollJudgment: scrollJudgment);
  }
  ...
  double applyBoundaryConditions(ScrollMetrics position, double value) {
    ...
    if (scrollJudgment.isRebound) return parent.applyBoundaryConditions(position, value);
    return 0.0;
  }
